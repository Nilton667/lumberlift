    ...
    <div>
        <div class="row">
			<div class="col-12">
				...
				<p>A sua privacidade é importante para nós. É política da Lumberlift respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a target="_blank" href="https://lumberlift.co.ao">lumberlift.co.ao</a>, e outros serviços que possuímos e operamos.</p>
				...
				<p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <a href='/termos'>políticas de privacidade</a>.</p>
				...
				<blockquote>
                    <h2 class="m-2">Política de Cookies</h2>
                </blockquote>
                ...
                <blockquote>
                    <h2 class="m-2">Mais informações</h2>
                </blockquote>
